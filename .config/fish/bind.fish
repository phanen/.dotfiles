if test $__fish_initialized -lt 3800
    ...
    bind \cg '_empty_then "_set_title yazi;commandline -f repaint" _fish_lookup'
    ...
    bind \cq '_empty_trim_then "_set_title lazygit;commandline -f repaint" fish_clipboard_copy'
    ...
    bind \cu '_empty_then "_set_title htop;commandline -f repaint" "commandline -f backward-kill-line"'
    ...
    bind ' ' '_empty_then "_set_title nvim;commandline -f repaint;" \'commandline -i " "\';commandline -f expand-abbr'
    return
end
...
bind ctrl-g '_empty_then "_set_title yazi;commandline -f repaint" _fish_lookup'
...
bind ctrl-q '_empty_trim_then "_set_title lazygit;commandline -f repaint" fish_clipboard_copy'
bind ctrl-r atuin_search
bind ctrl-s '_empty_then "_set_title nvim;commandline -f repaint" __fish_man_page'
bind ctrl-t 'commandline -i -- (fzf_files);commandline -f repaint'
bind ctrl-u '_empty_then "_set_title htop;commandline -f repaint" "commandline -f backward-kill-line"'
...
bind space '_empty_then "_set_title nvim;commandline -f repaint;" \'commandline -i " "\';commandline -f expand-abbr'
